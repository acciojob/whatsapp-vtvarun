...
public class WhatsappController {
    ...
    public String createUser(@RequestParam String name, @RequestParam String mobile) throws Exception {
        logger.info("POST MAPPING : add-user : In Controller");
    ...
    public int createMessage(String content) {
        ...
        logger.info("POST MAPPING : add-message : IN CONTROLLER");
    ...
    public int sendMessage(Message message, User sender, Group group) throws Exception {
        ...
        logger.info("PUT MAPPING : send-message : In Controller");
    ...
    public String changeAdmin(User approver, User user, Group group) throws Exception {
        ...
        logger.info("PUT MAPPING : change admin : IN Controller");
